    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          EplorerFeatureHorizontalListView(
            list: moreWaysToUber,
...
class EplorerFeatureHorizontalListView extends StatelessWidget {
  const EplorerFeatureHorizontalListView({
    super.key,
    required this.list,
    required this.title,
  });
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      list[index][2],
                      style: AppTextStyles.small8.copyWith(color: black87),
                    ),
                  ],
                ),
              );
