...
class AssetGenImage extends AssetImage {
  ...
  Image image(
      ...
      String? semanticaLabel,
      bool excludeFromSemantics = false,
      double? width,
      double? height,
      Color? color,
      BlendMode? colorBlenMode,
      BoxFit? fit,
    ...
    return Image(
      ...
      semanticLabel: semanticaLabel,
      excludeFromSemantics: excludeFromSemantics,
      width: width,
      height: height,
      color: color,
      colorBlendMode: colorBlenMode,
      fit: fit,
      alignment: alignment,
      repeat: repeat,
...
class SvgGenImage {
  const SvgGenImage(this._assetsName);

  final String _assetsName;
